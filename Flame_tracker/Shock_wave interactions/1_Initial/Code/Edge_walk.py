...
# 1. PATHS
BASE_PATH = r'D:\New and more complexed Flame Tracking\1_Initial_S20_Phi_1p15_S_2p5kV_D_150_R2_C001H001S0001'
INPUT_VIDEO_PATH = os.path.join(BASE_PATH, r'frames_mp4_videos\Flame_video_S0001.mp4')

OUTPUT_DIR = os.path.join(BASE_PATH, 'Analysis_Results (Analytical_Derivatives) (1_Initial) (n - (n-1)) (iterations=3)')
