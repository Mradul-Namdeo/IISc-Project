...
# --- Input/Output Paths ---
DATASETS_DIR = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p2_C001H001S0001\Datasets"
PLOTS_DIR = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p2_C001H001S0001\Plots"

ORIGINAL_RAW_FILE = os.path.join(DATASETS_DIR, "New_Phi_1p0_u_0p2_C001H001S0001.csv")
SCALED_DATA_FILE = os.path.join(DATASETS_DIR, "Phi_1p0_u_0p2_C001H001S0001_5sec.csv")
...
def create_star_norm_formula_image(params_list, filename):
    ...
    for params in params_list:
        ...
        formula = f'$P_{{{flame_id}}}^{{\\star}}(t_{{\\star}}) = {A:.2f} \\left(1 - e^{{-{k_star:.2f}(t_{{\\star}} - {t0_star:.4f})}}\\right) + {C_star:.2f}$'
...
def main():
    ...
    try:
        ...
        for flame_id in flame_ids:
            ...
            # --- MODIFIED: Use the average of the last 3 points per your request ---
