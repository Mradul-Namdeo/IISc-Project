...
# ===================================================================================
# --- MODIFIED: File Paths ---
IMAGE_FOLDER_PATH_INPUT = r"D:\Flame_tracking_ganesh_sir_final\Phi_1p0_u_0p3_C001H001S0001\Frames2"
TEMPLATE_FOLDER_PATH = r"D:\Flame_tracking_ganesh_sir_final\Phi_1p0_u_0p3_C001H001S0001_similar_images7"
# --- MODIFIED: Output CSV path updated ---
TRAJECTORY_OUTPUT_FILE = r"D:\Flame_tracking_ganesh_sir_final\Phi_1p0_u_0p3_C001H001S0001\Test_plots_Final2\Phi_1p0_u_0p3_C001H001S0001.csv"
VIDEO_OUTPUT_FOLDER = r"D:\Flame_tracking_ganesh_sir_final\Phi_1p0_u_0p3_C001H001S0001\Recorded tracking videos"
...
IGNITION_ZONE_MM = (0.0, 8.8, 210.0, 17.4) # Values * 10
# This is for the *background subtractor* (region for sensitive subtraction)
CLOSE_ZONE_RIGHT_PIPE_MM = (0.0, 9.6, 200.0, 16.6) # Values * 10, updated 20.0 -> 200.0
...
LOST_TIMEOUT_SECONDS = 0.25
RECORDING_CUTOFF_S = 0.15 # Updated from 0.20
DISPLAY_BOX_SIZE = (30, 30)
...
MIN_RECORD_DISTANCE_MM = 0.01 # Was 0.001 (MIN_RECORD_DISTANCE_CM * 10)
...
def main():
    ...
    VIDEO_OUTPUT_PATH = os.path.join(VIDEO_OUTPUT_FOLDER, f"{video_basename}_flame_tracked_(final2).mp4")
