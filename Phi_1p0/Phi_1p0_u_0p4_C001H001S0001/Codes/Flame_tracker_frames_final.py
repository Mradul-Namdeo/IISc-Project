...
# ===================================================================================
# --- MODIFIED: File Paths ---
IMAGE_FOLDER_PATH_INPUT = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p4_C001H001S0001\Phi_1p0_u_0p4_C001H001S0001_frames"
TEMPLATE_FOLDER_PATH = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p4_C001H001S0001\Phi_1p0_u_0p3_C001H001S0001_similar_images"
# --- MODIFIED: Output CSV path updated ---
TRAJECTORY_OUTPUT_FILE = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p4_C001H001S0001\Datasets\New_Phi_1p0_u_0p4_C001H001S0001.csv"
VIDEO_OUTPUT_FOLDER = r"D:\FREI_videos_Flame_tracking\Phi_1p0\Phi_1p0_u_0p4_C001H001S0001\Recorded tracking videos"
...
CLOSE_ZONE_RIGHT_PIPE_MM = (0.0, 9.6, 198.0, 16.6) # Values * 10, updated 20.0 -> 200.0
...
RECORDING_CUTOFF_S = 0.23 # Updated from 0.20
DISPLAY_BOX_SIZE = (45, 30)

# --- Advanced Refinement ---
USE_PERIODIC_REDETECTION = True
REDETECTION_INTERVAL = 8      # 8 :)
...
def main():
    ...
    VIDEO_OUTPUT_PATH = os.path.join(VIDEO_OUTPUT_FOLDER, f"{video_basename}_flame_tracked2.mp4")
